...
const ENDPOINT = 'https://chat-app-backend-black.vercel.app'
...
const SingleChat = ({fetchAgain, setFetchAgain}) => {
    ...
    const fetchAllMessages = async () => {
        ...
        try {
            setLoading(true)
            const result = await fetch(`https://chat-app-backend-black.vercel.app/api/message/allMessages/${selectedChat._id}`, {
                method: 'GET',
                headers: {
    ...
    const sendMessage = async (event) => {
        if(event.key === 'Enter' && newMessage) {
            ...
            try {
                // setLoading(true)
                setNewMessage('')
                const result = await fetch('https://chat-app-backend-black.vercel.app/api/message/sendMessage', {
                    method: 'POST',
                    headers: {
                        "Content-Type": "application/json",
                        "authToken": localStorage.getItem('token')
